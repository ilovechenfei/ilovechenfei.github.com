...
*/ (function(A, w) {
    ...
    c.extend({
        ...
        parseJSON: function(a) {
            ...
            if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@")
                ...
                .replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return A.JSON && A.JSON.parse ? A.JSON.parse(a) : (new Function("return " + a))();
    ...
    c.fn.extend({
        ...
        addClass: function(a) {
            ...
            if (a && typeof a === "string") for (var b = (a || "")
        ...
        removeClass: function(a) {
            ...
            if (a && typeof a === "string" || a === w) for (var b = (a || "")
                .split(ca), d = 0, f = this.length; d < f; d++) {
                var e = this[d];
        ...
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0, d = this.length; b < d; b++) if ((" " + this[b].className + " ")
                .replace(Aa, " ")
        ...
        var n = k.selectors = {
            ...
            preFilter: {
                CLASS: function(g, h, l, m, q, p) {
                    ...
                    p = 0;
                    for (var v;
                    (v = h[p]) != null; p++) if (v) if (q ^ (v.className && (" " + v.className + " ")
                        .replace(/[\t\n]/g, " ")
            ...
            filter: {
                ...
                ATTR: function(g, h) {
                    ...
                    var m = h[2];
                    h = h[4];
                    return g == null ? m === "!=" : m === "=" ? l === h : m === "*=" ? l.indexOf(h) >= 0 : m === "~=" ? (" " + l + " ")
        ...
        (function() {
            ...
            if (s.getElementById(h)) {
                n.find.ID = function(m, q, p) {
                    if (typeof q.getElementById !== "undefined" && !p) return (q = q.getElementById(m[1])) ? q.id === m[1] || typeof q.getAttributeNode !== "undefined" && q.getAttributeNode("id")
                        .nodeValue === m[1] ? [q] : w : []
                };
    ...
    c.fn.extend({
        ...
        remove: function(a, b) {
            for (var d = 0, f;
            (f = this[d]) != null; d++) if (!a || c.filter(a, [f])
                .length) {
                if (!b && f.nodeType === 1) {
